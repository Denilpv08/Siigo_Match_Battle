  ...
  <div class="row" style="margin: auto;">
    <div class="col-sm-12">
      <div class="card border-dark mb-3" style="max-width: 20rem; background-color: #333333; color: rgb(248 248 255);">
          <div class="card-header bg-transparent border-dark">7 A</div>
              <!--<div class="card-body">-->
                  <img src="{{ asset('img/moto7.jpg') }}"  height="310px" width="318px" alt="img">
              <!--</div>-->
          <div class="card-footer bg-transparent border-dark">
              <label for="">CILINDRAJE:</label> 
              <label for="" style="float: right;">378 cc</label>
              <br>
              <label for="">POTENCIA:</label> 
              <label for="" style="float: right;">36.2 HP @ 9000 rpm</label>
              <br>
              <label for="">TORQUE:</label> 
              <label for="" style="float: right;">35 Nm @ 6500 rpm</label>
              <br>
